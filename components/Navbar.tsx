          ...
          >
            {userSession?.avatarUrl ? (
              <img
                ...
                alt="Profile"
                className="h-8 w-8 rounded-full object-cover shadow-sm ring-2 ring-sky-500/20"
              />
            ) : (
          ...
          {showProfileMenu && (
            <div className="absolute top-full right-0 mt-2 w-56 bg-white border border-slate-200 rounded-2xl shadow-xl z-50 overflow-hidden p-1 text-xs text-left animate-in fade-in">
              ...
              <button
                ...
                className="w-full flex items-center gap-2 px-3 py-2 text-slate-700 hover:bg-slate-100 rounded-xl font-semibold transition"
              >
